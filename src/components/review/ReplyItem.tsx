...
// components/review/ReplyItem.tsx
import { useState } from "react";
import { useSelector } from "react-redux";
import type { RootState } from "@/redux/store";
import type { IReply } from "@/types/review";
import { toast } from "react-toastify";
import { formatDistanceToNow } from "date-fns";
import { useDeleteReviewMutation, useEditReviewMutation, useReplyToReviewMutation } from "@/redux/features/reviews/reviewApi";
    ...
    try {
      await replyToReview({
        ...
        data: {
          ...
          parentReplyId: reply._id.toString(), // nested reply
        },
      }).unwrap();
  ...
  return (
    <div className="bg-gray-50 rounded-lg p-3">
      <div className="flex items-start gap-3">
        <img
          src={reply.author.avatar?.url || "/default-avatar.png"}
